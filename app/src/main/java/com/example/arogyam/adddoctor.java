...
public class adddoctor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timeMedicine=findViewById(R.id.etMedicine);
        ...
        setTime.setOnClickListener((v) -> {
            ...
            timePickerDialog = new TimePickerDialog(adddoctor.this, new TimePickerDialog.OnTimeSetListener() {
                @Override
...
//-------------------------1st Alarm---------------------------------------
                    ...
                    intent.putExtra(AlarmClock.EXTRA_MESSAGE, timeMedicine.getText().toString());
//--------------------------End----------------------------------------------
...
//-------------------------2nd Alarm---------------------------------------
                    ...
                    intent2.putExtra(AlarmClock.EXTRA_MESSAGE, timeMedicine.getText().toString());
//--------------------------End----------------------------------------------
...
//-------------------------3rd Alarm---------------------------------------
                    ...
                    intent3.putExtra(AlarmClock.EXTRA_MESSAGE, timeMedicine.getText().toString());
//--------------------------End----------------------------------------------
                    ...
                    if(intent.resolveActivity(getPackageManager()) != null) {
                        ...
                        Toast.makeText(adddoctor.this, "There is no app that support this action", Toast.LENGTH_SHORT).show();
                    }
                }else{
                    Toast.makeText(adddoctor.this,"Please choose a time", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
